...
$Bname=$fetch1['1'];
$sql = mysqli_query($con , "INSERT INTO `customers`(`Name`, `Paid`, `RegDate`, `Bundle`, `StartingDate`, `Phone`, `Shift`, `EndingDate`, `Gender`, `Address`, `Custimage`) VALUES ('$Name','0','$RDate','$Bname','$StartingD','$Phone','$Shift','$EndingD','$Gender','$Address','$Picture1')");
$deleted=mysqlI_query($con,"DELETE FROM `enrollment` WHERE `ID`='$ID'");
if ($sql) {
    // $success = '<script>
            ...
            <div id="content">
               ...
               <?php include 'topbar.php'; ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text text-center"><i class="fas fa-pen"></i>Add Customer info</h1>
                    <form class="user" method="POST" enctype="multipart/form-data">
                    <?php 
                    include 'config.php';
                    $ID=$_GET['ID'];
                    $q=mysqli_query($con,"SELECT * FROM enrollment WHERE ID='$ID'");
                    $f=mysqli_fetch_array($q);
                     ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <select name="Gender" class="form-control font-weight-bold" id="exampleInputEmail" 
                                            ...
                                            <option selected="" class="font-weight-bold"><?php echo $f['2']; ?></option>
                            ...
                            <select name="BundlePrice" class="form-control " id="exampleInputEmail" style="border-radius: 20px ">
                                            <option selected="" ><?php echo $f['3']; ?></option>
                                           <?php 
                                            include 'config.php';
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <select name="Shift" class="form-control font-weight-bold" id="exampleInputEmail" 
                                            style="border-radius: 20px" required>
                                            <option selected="" class="font-weight-bold"><?php echo $f['5']; ?></option>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="Address" class="form-control form-control-user font-weight-bold" id="exampleRepeatPassword" placeholder="Address" value="<?php echo $f['7']; ?>">
                                        <?php if (isset($_POST['add'])): ?>
                                                <?php if (empty($Phone)): ?>
                                                   <?php $check4 = '<script>
                                                   alertify.error("Enter Your Phone No");
                        ...
                        <div class="col-sm-12 mb-3">
                                    <input type="file" class=" " id="exampleFirstName" name="Picture1" value="<?php echo $f['14']; ?>">
