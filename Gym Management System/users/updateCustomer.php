...
$Days=$fetch1['3'];
$Bname=$fetch1['1'];
$sql = mysqli_query($con , "UPDATE `customers` SET `Name`='$Name',`Paid`='0',`RegDate`='$RDate',`Bundle`='$Bname',`StartingDate`='$StartingD',`Phone`='$Phone',`Shift`='$Shift',`EndingDate`='$EndingD',`Gender`='$Gender',`Address`='$Address', Days='$Days' WHERE ID='$ID'");
if ($sql) {
    // $success = '<script>
    ...
    // </script>';
     echo "<script type='text/javascript'>
        ...
        location.replace('payment.php?ID=$ID')
        </script>";
} 
else {
        //   $Danger =  '<script>
